...
// The Ibex-specific mcause value for an internal NMI generated by a load
// integrity error, as detailed in the Ibex Reference Guide, section "Exceptions
// and Interrupts".
pub const IBEX_LOAD_INTEGRITY_ERROR_NMI_MCAUSE: usize = 0xFFFFFFE0;
