    ...
    views::main_dialog(
        LinearLayout::vertical().child(cursive::views::ScrollView::new(views::select_menu(
            vec![
                ...
                items::SupportedCapsule::P256.to_menu_item(),
                items::SupportedCapsule::P384.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA256.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA384.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA512.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA3_224.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA3_256.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA3_384.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHA3_512.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHAKE128.to_menu_item(),
                items::SupportedCapsule::ONESHOT_SHAKE256.to_menu_item(),
                items::SupportedCapsule::ONESHOT_CSHAKE128.to_menu_item(),
                items::SupportedCapsule::ONESHOT_CSHAKE256.to_menu_item(),
                items::SupportedCapsule::ONESHOT_HMAC_SHA256.to_menu_item(),
                items::SupportedCapsule::ONESHOT_HMAC_SHA384.to_menu_item(),
                items::SupportedCapsule::ONESHOT_HMAC_SHA512.to_menu_item(),
                items::SupportedCapsule::ONESHOT_KMAC128.to_menu_item(),
                items::SupportedCapsule::ONESHOT_KMAC256.to_menu_item(),
            ],
